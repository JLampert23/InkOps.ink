...
export function ProofsManager() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900">Proofs & Approvals</h2>
        <p className="text-sm text-gray-600 mt-1">Review and approve artwork proofs</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-600">Proofs will appear here when they are uploaded</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProofs.map((proof) => (
            <div key={proof.id} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
              ...
              <div className="p-4">
                <div className="mb-3">
                  <h3 className="text-sm font-semibold text-gray-900">Order #{proof.orderNumber}</h3>
                  <p className="text-xs text-gray-600">{proof.customerName}</p>
                </div>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Proof Review</h3>
                  <p className="text-sm text-gray-600 mt-1">Order #{selectedProof.orderNumber} - Version {selectedProof.version}</p>
                </div>
                <button
                  onClick={() => {
                    setShowProofModal(false);
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-base text-gray-900 mt-1">{selectedProof.customerName}</p>
                </div>
                <div>
