...
type ProductionTab = 'quotes' | 'work-orders' | 'scheduling' | 'manage-goods' | 'customers';
...
export function ProductionDashboard() {
  ...
  const tabs = [
    ...
    { id: 'customers' as ProductionTab, label: 'Customers', icon: Users, description: 'Customer database' },
  ];
