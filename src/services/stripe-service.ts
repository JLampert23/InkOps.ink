    ...
    try {
      ...
      const { data: invoiceRecord, error: insertError } = await supabase
        ...
        .insert([{
          ...
          minimum_due_amount: minimumDueCents,
          amount_paid: 0,
          amount_remaining: totalAmountCents,
          currency: 'usd',
      ...
      return {
        ...
        totalAmount: parseFloat(invoiceRecord.total_amount) / 100,
        minimumDueAmount: parseFloat(invoiceRecord.minimum_due_amount) / 100,
        amountPaid: parseFloat(invoiceRecord.amount_paid) / 100,
        amountRemaining: parseFloat(invoiceRecord.amount_remaining) / 100,
