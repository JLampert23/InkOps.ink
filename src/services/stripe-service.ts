  ...
  async getStripeInvoice(printavoInvoiceId: string): Promise<StripeInvoice | null> {
    try {
      ...
      return {
        ...
        minimumDueAmount: parseFloat(data.minimum_due_amount),
        amountPaid: parseFloat(data.amount_paid),
        amountRemaining: parseFloat(data.amount_remaining),
  ...
  async refreshStripeInvoiceStatus(printavoInvoiceId: string): Promise<StripeInvoice | null> {
    try {
      ...
      return {
        ...
        amountRemaining: parseFloat(updated.amount_remaining),
