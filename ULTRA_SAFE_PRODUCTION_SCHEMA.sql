-- =============================================================================
-- ULTRA SAFE PRODUCTION SCHEMA - InkOps Platform
-- =============================================================================
-- This version adds missing columns before creating any references
-- Safe to run on ANY existing database
-- =============================================================================

-- =============================================================================
-- STEP 1: Create base tables without company_id (if they don't exist)
-- =============================================================================
...
-- =============================================================================
-- STEP 2: Add company_id columns to all tables (safe, checks if exists first)
-- =============================================================================
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE user_profiles ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE customers ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE customer_contacts ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;

  -- printavo_invoices.company_id
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'printavo_invoices' AND column_name = 'company_id'
  ) THEN
    ALTER TABLE printavo_invoices ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;

  -- printavo_line_items.company_id
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'printavo_line_items' AND column_name = 'company_id'
  ) THEN
    ALTER TABLE printavo_line_items ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE printavo_payments ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE payments ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE stripe_customers ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE stripe_payment_intents ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE stripe_invoices ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;

  -- stripe_payment_links.company_id
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'stripe_payment_links' AND column_name = 'company_id'
  ) THEN
    ALTER TABLE stripe_payment_links ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;

  -- stripe_payments.company_id
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'stripe_payments' AND column_name = 'company_id'
  ) THEN
    ALTER TABLE stripe_payments ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;

  -- billing_queue.company_id
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'billing_queue' AND column_name = 'company_id'
  ) THEN
    ALTER TABLE billing_queue ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE billing_attempts ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE communication_logs ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;

  -- paid_invoices.company_id
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'paid_invoices' AND column_name = 'company_id'
  ) THEN
    ALTER TABLE paid_invoices ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE automations ADD COLUMN company_id uuid REFERENCES company_settings(id) ON DELETE CASCADE;
  END IF;
END $$;
...
BEGIN
  ...
  -- printavo_invoices.status_stage
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
  ...
  IF NOT EXISTS (
    ...
    WHERE table_name = 'user_profiles' AND constraint_name LIKE '%role%'
  ) THEN
    ALTER TABLE user_profiles DROP CONSTRAINT IF EXISTS user_profiles_role_check;
    ALTER TABLE user_profiles ADD CONSTRAINT user_profiles_role_check
      CHECK (role IN ('super_admin', 'admin', 'finance', 'production', 'user'));
  END IF;
END $$;
...
-- Stripe tables (simplified policies)
