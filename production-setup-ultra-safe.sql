-- =============================================================================
-- PRODUCTION DATABASE SETUP - ULTRA SAFE VERSION
-- =============================================================================
-- This script adapts to existing schema and only adds what's missing
...
DO $$
BEGIN
  RAISE NOTICE 'Starting ultra-safe production database setup...';
END $$;
...
-- =============================================================================
-- STEP 2: Add company_id to existing tables if missing
-- =============================================================================
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'Added company_id to printavo_invoices';
  END IF;
  ...
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'Added company_id to printavo_line_items';
  END IF;
  ...
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'Added company_id to printavo_payments';
  END IF;

  -- Add financial lock fields to printavo_invoices
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'printavo_invoices' AND column_name = 'financially_locked'
  ) THEN
    ALTER TABLE printavo_invoices ADD COLUMN financially_locked BOOLEAN DEFAULT FALSE;
    RAISE NOTICE 'Added financially_locked to printavo_invoices';
  END IF;
  ...
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'Added locked_at to printavo_invoices';
  END IF;
  ...
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'Added locked_by to printavo_invoices';
  END IF;

  -- Add status_stage to printavo_invoices
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    ...
    RAISE NOTICE 'Added status_stage to printavo_invoices';
  END IF;

  -- Add company info columns to printavo_invoices
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'printavo_invoices' AND column_name = 'company_name'
  ) THEN
    ALTER TABLE printavo_invoices ADD COLUMN company_name TEXT;
    RAISE NOTICE 'Added company_name to printavo_invoices';
  END IF;

  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'printavo_invoices' AND column_name = 'company_logo_url'
  ) THEN
    ...
    RAISE NOTICE 'Added company info columns to printavo_invoices';
  END IF;
END $$;
...
-- =============================================================================
-- STEP 4: Create payments table with proper structure
-- =============================================================================
...
-- =============================================================================
-- STEP 9: Create signup trigger function
-- =============================================================================
...
BEGIN
  RAISE NOTICE '=============================================================================';
  RAISE NOTICE 'Ultra-safe production database setup complete!';
  RAISE NOTICE '=============================================================================';
  RAISE NOTICE 'Key tables and policies are now in place.';
  RAISE NOTICE 'You can now test user signup at your production site.';
  RAISE NOTICE '=============================================================================';
END $$;
