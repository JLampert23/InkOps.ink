/*
  # Fix work order number type cast in process_quote_approval

  The work order number generation had an operator type mismatch:
  `int + text` instead of `(int + 1)::text`

  ## Fix
  - Corrected LPAD expression to cast the full arithmetic result to text
*/
