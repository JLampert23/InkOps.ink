/*
  # Fix invoice status_stage in process_quote_approval

  The trigger was setting status_stage to 'unpaid' which violates the
  printavo_invoices_status_stage_check constraint.
  Allowed values: billing_queue, accounts_receivable, paid.
  New invoices from quote approval should start in 'billing_queue'.
*/
