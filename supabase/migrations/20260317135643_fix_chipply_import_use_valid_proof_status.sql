/*
  # Fix Chipply Import - Use Valid Proof Status

  1. Problem
    - Function uses 'pending_review' which is not a valid status
    - Valid statuses: 'draft', 'pending_approval', 'approved', 'rejected'

  2. Solution
    - Change status to 'pending_approval' for imported proofs
*/
