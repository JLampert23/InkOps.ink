/*
  # Fix Quote Line Items Column Reference

  1. Changes
    - Removes reference to non-existent 'line_total' column
    - Uses only 'total_price' column which exists
*/
  ...
  IF NEW.status = 'approved' AND (OLD.status IS NULL OR OLD.status != 'approved') THEN
    ...
    FOR v_line_item IN
      SELECT qli.*, 
        ...
        COALESCE(qli.total_price, qli.quantity * qli.unit_price, 0) as calculated_total
    ...
    LOOP
      ...
      VALUES (v_invoice_id, NEW.company_id, v_line_item.line_type, v_line_item.brand,
        ...
        v_line_item.unit_price, v_line_item.calculated_total,
