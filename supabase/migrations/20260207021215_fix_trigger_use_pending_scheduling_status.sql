/*
  # Fix quote approval trigger to use 'Pending Scheduling' status for new work orders

  Changes the process_quote_approval function so new work orders are created
  with status 'Pending Scheduling' to match the workflow board column names.
*/
