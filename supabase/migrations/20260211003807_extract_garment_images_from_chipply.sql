/*
  # Extract Garment Images from Chipply Import

  1. Changes
    - Extract image1Url, image2Url, image3Url from Chipply payload
    - Store in garment_image_url, garment_image_rear_url, garment_image_side_url columns
    - Images are now displayed by group in the UI
*/
    ...
    FOR j IN 0..(v_products_length - 1) LOOP
      ...
      FOR k IN 0..(v_colors_length - 1) LOOP
        ...
        INSERT INTO quote_line_items (
          ...
          group_label,
          garment_image_url,
          garment_image_rear_url,
          garment_image_side_url,
          notes,
          created_at
        ) VALUES (
          v_quote_id,
