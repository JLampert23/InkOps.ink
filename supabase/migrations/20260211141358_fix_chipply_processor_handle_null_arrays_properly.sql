/*
  # Fix Chipply Import to Handle Null Arrays
  
  1. Changes
    - Add null checks before all array loops
    - Use COALESCE to provide empty arrays
*/
...
BEGIN
  ...
  -- Check if processes array exists and has elements
