/*
  # Fix Chipply Processor - Use Correct Imprints Schema

  1. Changes
    - Use `type_of_work` instead of `imprint_type`
    - Use `details` instead of `imprint_description`
    - Add `company_id` to quote_imprints
    - Use `imprint_number` as text
*/
