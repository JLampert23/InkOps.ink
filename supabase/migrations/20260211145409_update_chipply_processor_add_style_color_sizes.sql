/*
  # Update Chipply Processor - Add Style Number, Color, and Individual Sizes

  1. Changes
    - Extract styleName → item_number column
    - Extract colorName → color column
    - Parse sizes array into adult_sizes/youth_sizes jsonb
    - Set size_mode based on sizes found (youth/adult/regular)

  2. Size Mapping
    - Youth sizes (YS, YM, YL, YXL) → youth_sizes
    - Adult sizes (XS, S, M, L, XL, 2XL, 3XL, 4XL, 5XL, 6XL) → adult_sizes
    - Regular sizes (One Size, OS) → regular_sizes
*/
