/*
  # Fix Chipply Import - Use Correct Garment Image Column Names

  1. Problem
    - Function tries to use garment_image_2_url and garment_image_3_url which don't exist
    - Actual columns: garment_image_url, garment_front_image_url, garment_back_image_url, garment_side_image_url

  2. Solution
    - Map Chipply image1Url to garment_image_url (primary)
    - Map image2Url to garment_back_image_url
    - Map image3Url to garment_side_image_url
    - Update proof records to use matching column names
*/
