/*
  # Fix Chipply Import - Use Only Existing Size Columns

  1. Problem
    - Function tries to use qty_xxs and qty_6xl which don't exist
    - Actual columns: qty_yxs, qty_ys, qty_ym, qty_yl, qty_yxl, qty_xs, qty_s, qty_m, qty_l, qty_xl, qty_2xl, qty_3xl, qty_4xl, qty_5xl

  2. Solution
    - Remove references to non-existent columns
    - Use only the columns that actually exist in the schema
*/
