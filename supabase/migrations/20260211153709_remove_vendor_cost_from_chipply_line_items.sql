/*
  # Remove Vendor and Cost from Chipply Line Item Notes

  1. Changes
    - Removes the vendor name and cost information from line item notes
    - Cleans up the line item description to only show product details
*/
