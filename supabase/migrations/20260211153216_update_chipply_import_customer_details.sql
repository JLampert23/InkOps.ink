/*
  # Update Chipply Import - Add Customer Details

  1. Changes
    - Populates customer billing fields from Chipply data
    - Sets nickname field with store name, batch ID, and date
    - Extracts customer contact information from accountSummary

  2. Fields Updated
    - bill_name, bill_company (from customerName)
    - customer_email, customer_phone (from accountSummary)
    - nickname (formatted as "Store | Batch | Date")
    - bill_address fields (if available in payload)
*/
