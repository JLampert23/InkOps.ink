/*
  # Fix Chipply Processor - Correct JSONB Loop Syntax

  1. Changes
    - Fix FOR loop to properly extract JSONB values from array elements
    - Use `value` column explicitly instead of `SELECT *`
*/
